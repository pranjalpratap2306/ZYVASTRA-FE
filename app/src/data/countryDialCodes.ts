export type CountryDial = { name: string; iso2: string; dial: string };

// A comprehensive list of countries and calling codes (condensed formatting, no spaces in dial)
// Source consolidated from ITU/E.164 public references. Some territories share the same code; we include principal names.
