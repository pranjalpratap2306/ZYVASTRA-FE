...
export const ProductDetailScreen: React.FC<any> = ({ route }) => {
  ...
  return (
    <ScrollView style={styles.shell}>
      <HeaderBar />
      <View style={styles.wrap} contentContainerStyle={{ paddingBottom: 28 }}>
        <View style={styles.page}>
          ...
          <View style={[styles.heroRow, isNarrow && { flexDirection: 'column' }]}> 
            <View style={[styles.imageCard, isNarrow && { marginBottom: 12 }]}> 
              <Image source={typeof imageUrl === 'string' ? { uri: imageUrl } : imageUrl} style={[styles.image, isNarrow && styles.imageNarrow]} resizeMode="cover" />
            </View>
            ...
            <View style={[styles.specRow, isNarrow && styles.specRowNarrow]}><Text style={styles.specKey}>Business Type</Text><Text style={[styles.specVal, isNarrow && styles.specValNarrow]}>Manufacturer, Exporter, Supplier</Text></View>
            <View style={[styles.specRow, isNarrow && styles.specRowNarrow]}><Text style={styles.specKey}>Material</Text><Text style={[styles.specVal, isNarrow && styles.specValNarrow]}>100% Cotton</Text></View>
            <View style={[styles.specRow, isNarrow && styles.specRowNarrow]}><Text style={styles.specKey}>Color</Text><Text style={[styles.specVal, isNarrow && styles.specValNarrow]}>Multicolor</Text></View>
            <View style={[styles.specRow, isNarrow && styles.specRowNarrow]}><Text style={styles.specKey}>Sleeve Type</Text><Text style={[styles.specVal, isNarrow && styles.specValNarrow]}>Full Sleeve</Text></View>
...
const styles = StyleSheet.create({
  ...
  wrap: { flex: 1 },
  page: { width: '100%', maxWidth: 1120, alignSelf: 'center', paddingHorizontal: 16 },
  headerBar: { height: 4, width: 48, backgroundColor: colors.brandGold, borderRadius: 2, marginTop: 12 },
  title: { color: colors.brandNavy, fontWeight: '900', fontSize: 24, paddingTop: 8, marginBottom: 8 },
  ...
  specRowNarrow: { flexDirection: 'column', alignItems: 'flex-start', gap: 4 },
  specKey: { color: colors.textSecondary },
  specVal: { color: colors.textPrimary, fontWeight: '700' },
  specValNarrow: { textAlign: 'left' as any, width: '100%' },
  ...
  table: { backgroundColor: colors.surface, borderRadius: 12, borderWidth: 1, borderColor: colors.border, padding: 16, marginTop: 12, shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 10, shadowOffset: { width: 0, height: 4 } },
  ...
  enquiry: { backgroundColor: colors.surface, borderRadius: 12, borderWidth: 1, borderColor: colors.border, padding: 16, marginTop: 12, shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 10, shadowOffset: { width: 0, height: 4 } },
